...
* Prácticas cuestionables de investigación (QRP)
  1. Fabrication, Falsification, Plagiarism (Invención, Falsificación y Plagio - FPP)
  2. Conducta Responsable de Investigación (RCR)
...
* Prácticas de investigación orientadas a la reproducibilidad:
  ...
  * Protocolos de trabajo reproducible (TIER)
